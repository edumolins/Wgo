...
public class FlightAdapter extends ArrayAdapter<ObjFlight> {

    private Activity context;
    private ArrayList<ObjFlight> datos;

    public FlightAdapter(Activity ctx, ArrayList<ObjFlight> datos) {
        super(ctx, R.layout.flight_row, datos);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
    	...
    	if(item == null)
		{
			...
			View viewGroup = inflater.inflate(R.layout.flight_row, parent, false);
